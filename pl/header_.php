...
<head>
	...
	<title>Krakow - Night Tram Party - Best All Night Party in Krakow ! [Malopolska, Poland]</title>
    <link rel="icon" type="image/png" sizes="16x16" href="img/favicon.png">
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta http-equiv="Content-Language" content="en" />
    <meta name="title" content ="Kraków - Night Tram Party">
    <meta name="keywords" content="event,party,nighttramparty,night,tram,krakow,disco,club,bar,drink,poland,trip,hostel,girls,boys,hot party,coctail,impreza,krakow,tramwaj,dyskoteka">
            ...
            <ul class="nav navbar-nav navbar-blue">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a href="offer.php?p=bechelor">Wieczory Kawalerskie</a></li>
                        <li><a href="offer.php?p=theme">Imprezy tematyczne</a></li>
                        <li><a href="offer.php?p=surprise">Niespodzianki</a></li>
                        <li><a href="offer.php?p=integration">Imprezy Integracyjne</a></li>
                    </ul>
                </li>
