...
<div class="container offer-page site-header">
    <ul class="row title">
        ...
        <div class="">
            <h1>Konkursy..<?php //echo $eventMessage; ?></h1>
			<h3>Organizujemy konkursy w których można wygrać<br>darmowe bilety na nasze imprezy, podkoszulki, plecaki..<br>
			<br>
			
			Aktualne konkursy znajdziesz w tej zakładce wkrótce.
			</h3>
