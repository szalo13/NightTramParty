...
<div class="container offer-page site-header">
    <ul class="row title">
        ...
        <div class="">
            <h1>Jobs..<?php //echo $eventMessage; ?></h1>
			
			
			<h3>
			<p>
			
			Give the world a fun !!<br>It's an idea that comes to life through the hundreds of events<br>performed each year by NIGHTRAMPARTY TEAM..<br><br>And it all can begins.. with brilliant people like you..<br><br>
